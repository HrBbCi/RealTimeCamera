...
public class MTCNN {
    ...
    //MODEL PATH
    private static final String MODEL_FILE = "file:///android_asset/mtcnn.tflite";
    //tensor name
    private static final String PNetInName = "pnet/input";
    private static final String[] PNetOutName = new String[]{"pnet/prob1", "pnet/conv4-2/BiasAdd"};
    private static final String RNetInName = "rnet/input";
    private static final String[] RNetOutName = new String[]{"rnet/prob1", "rnet/conv5-2/conv5-2",};
    private static final String ONetInName = "onet/input";
    private static final String[] ONetOutName = new String[]{"onet/prob1", "onet/conv6-2/conv6-2", "onet/conv6-3/conv6-3"};
    ...
    private Bitmap bitmapResize(Bitmap bm, float scale) {
        Log.d("pre", bm.getWidth()+";"+bm.getHeight());
        ...
        Log.d("reeee", resizedBitmap.getWidth()+";"+resizedBitmap.getHeight());
